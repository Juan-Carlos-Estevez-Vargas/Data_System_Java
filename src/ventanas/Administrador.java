...
public class Administrador extends javax.swing.JFrame {
    ...
    public Administrador() {
        initComponents();
        user = Login.user; //Rescatamos el nombre de usuario de la interfaz Login
        ...
        try {
            ...
            if (rs.next()) { //Si hay coincidencias
                nombre_usuario = rs.getString("nombre_usuario"); //getString recupera lo que deseemos de la consulta
    ...
    private void initComponents() {
        ...
        jLabel_NombreUsuario.setFont(new java.awt.Font("Segoe UI", 1, 20)); // NOI18N
