...
public class InformacionEquipo extends javax.swing.JFrame {
    ...
    int id_cliente_update = 0, id_equipo = 0;
    ...
    public InformacionEquipo() {
        ...
        this.setTitle("Equipo del cliente " + nom_cliente);
    ...
    private void jButton_ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarActionPerformed
        ...
        observaciones = jTextPane_danio_reportado.getText().trim();
        ...
        if (observaciones.equals("")) {
            jTextPane_danio_reportado.setText("Sin observaciones");
        }
        ...
        if (validacion == 0) {
            ...
            try {
                ...
                PreparedStatement pst = cn.prepareStatement(
                        ...
                        + "ultima_modificacion = ? WHERE id_equipo = '" + id_equipo + "'");
