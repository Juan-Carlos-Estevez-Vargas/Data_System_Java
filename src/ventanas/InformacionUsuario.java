...
public class InformacionUsuario extends javax.swing.JFrame {
    ...
    public InformacionUsuario() {
        initComponents();
        user = Login.user;
        user_update = GestionarUsuarios.user_update; //Guardamos el usuario seleccionado en la tabla usuarios
    ...
    private void initComponents() {
        ...
        txt_registradoPor.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
