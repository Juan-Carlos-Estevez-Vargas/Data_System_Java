...
public class RegistrarUsuarios extends javax.swing.JFrame {
    ...
    public RegistrarUsuarios() {
        initComponents();
        user = Login.user; //Obtenemos el nombre de usuario de quien inicio sesion
    ...
    private void initComponents() {
        ...
        txt_mail.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
    ...
    private void jButton_RegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_RegistrarActionPerformed
        ...
        permisos_cmb = cmb_niveles.getSelectedIndex() + 1; //Guardamos lo que esta en el comboBox
        ...
        switch (permisos_cmb) {
            ...
            case 2 -> permisos_string = "Capturista";
            case 3 -> permisos_string = "Tecnico";
            default -> {
            }
        }
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (validacion == 0) { //Si no hubo ningun campo vacio podra registrar usuarios
